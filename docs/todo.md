...
- [x] Gateway ingest (`campaign-ingest` + SSE `ingest_done`)
- [x] `verify:ubuntu:all` — Ubuntu 一键验证脚本
- [x] [implementation-map.md](./implementation-map.md) — design ↔ code traceability
